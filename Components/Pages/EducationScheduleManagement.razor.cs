...
namespace EducationSchedule.Components.Pages
{
    public partial class EducationScheduleManagement
    {
        ...
        private string _academicSemester = string.Empty;
        private string _professorName = string.Empty;
        private string[] airlines { get; set; } = new[] { "First Year", "Second Year", "Third Year", "Final Year" };
        private string[] startPlaces { get; set; } = new[] { "Semester 1", "Semester 2", "Semester 3", "Semester 4", "Semester 5", "Semester 6", "Semester 7", "Semester 8" };
        private string[] professorNames { get; set; } = new[] 
        {
            "Arindama Singh",
            "Arti Dua",
            "Balaraman Ravindran",
        ...
        private static List<Course> GetCourse()
        {
            List<Course> courses = new List<Course>()
            {
                ...
                new Course(){ CourseId = 23, Department = "Semester 3" , Batch = "2022-2026", SubjectCode = "HS4060", SubjectName = "Humanities Elective 1", Professor = "C.Balaji", PortionCompletion = 100,  StartDate = new DateTime(2023, 06, 12), Duration = "74", ParentId = 21 },
                new Course(){ CourseId = 24, Department = "Semester 3" , Batch = "2022-2026", SubjectCode = "CS2700", SubjectName = "Programming and Data Structures", Professor = "Rupesh Nasre", StartDate = new DateTime(2023, 06, 19), Duration = "74", PortionCompletion = 100, ParentId = 21 },
                new Course(){ CourseId = 25, Department = "Semester 3" , Batch = "2022-2026", SubjectCode = "CS2710", SubjectName = "Programming and Data Structures Lab", Professor = "Meghana Nasre", StartDate = new DateTime(2023, 06, 26), Duration = "73", PortionCompletion = 100, ParentId = 21 },
                new Course(){ CourseId = 26, Department = "Semester 3" , Batch = "2022-2026", SubjectCode = "CS2300", SubjectName = "Foundations of Computer Systems Design", Professor = "C.Chandra Sekhar", StartDate = new DateTime(2023, 07, 03), Duration = "73", PortionCompletion = 100, ParentId = 21 },
                new Course(){ CourseId = 27, Department = "Semester 3" , Batch = "2022-2026", SubjectCode = "CS2310", SubjectName = "Foundations of Computer Systems Design Lab", Professor = "Madhu Mutyam", StartDate = new DateTime(2023, 07, 03), Duration = "73", PortionCompletion = 100, ParentId = 21 },

                new Course(){CourseId = 28, Department = "Partical Exams", StartDate = new DateTime(2023,11,01), Duration="4", PortionCompletion = 100, ParentId = 21, Predecessor = "24,26" },
                new Course(){CourseId = 29, Department = "Theoretical Exams", StartDate = new DateTime(2023,11,08), Duration="15", PortionCompletion = 100, ParentId = 21, Predecessor = "21,22,23,25"},

                new Course(){ CourseId = 30, Department = "Semester 4" , Batch = "2022-2026", SubjectCode = "CS2200", SubjectName = "Languages, Machines, and Computations", Professor = "John Augustine", StartDate = new DateTime(2024, 01, 08), Duration = "72", PortionCompletion = 90, ParentId = 21 },
                new Course(){ CourseId = 31, Department = "Semester 4" , Batch = "2022-2026", SubjectCode = "CS2800", SubjectName = "Design and Analysis of Algorithms", Professor = "Shweta Agrawal" , StartDate = new DateTime(2024, 01, 15), Duration = "75", PortionCompletion = 78, ParentId = 21 },
                new Course(){ CourseId = 32, Department = "Semester 4" , Batch = "2022-2026", SubjectCode = "CS2600", SubjectName = "Computer Organization and Architecture", Professor = "C.Chandra Sekhar", StartDate = new DateTime(2024, 01, 22), Duration = "72", PortionCompletion = 74, ParentId = 21 },
                new Course(){ CourseId = 33, Department = "Semester 4" , Batch = "2022-2026", SubjectCode = "CS2610", SubjectName = "Computer Organization and Architecture Lab", Professor = "C.Chandra Sekhar", StartDate = new DateTime(2024, 01, 29), Duration = "72", PortionCompletion = 64, ParentId = 21 },
                new Course(){ CourseId = 34, Department = "Semester 4" , Batch = "2022-2026", SubjectCode = "CS2810", SubjectName = "Object-Oriented Algorithms Implementation and Analysis Lab", Professor = "Kartik Nagar", StartDate = new DateTime(2024, 02, 05), Duration = "72", PortionCompletion = 57, ParentId = 21 },
                new Course(){ CourseId = 35, Department = "Semester 4" , Batch = "2022-2026", SubjectCode = "MA2040", SubjectName = "Probability, Stochastic Process and Statistics", Professor = "Sarang Sane",  StartDate = new DateTime(2024, 02, 12), Duration = "72", PortionCompletion = 46, ParentId = 21 },

                new Course(){CourseId = 36, Department = "Partical Exams", StartDate = new DateTime(2024,05,08), Duration="4", PortionCompletion = 0, ParentId = 21, Predecessor = "32,33" },
                new Course(){CourseId = 37, Department = "Theoretical Exams", StartDate = new DateTime(2024,05,15), Duration="15", PortionCompletion = 0, ParentId = 21, Predecessor = "29,30,31,34"},

                new Course(){ CourseId = 38, Department = "Third Year" , Batch = "2021-2025", },
                new Course(){ CourseId = 39, Department = "Semester 5" , Batch = "2021-2025", SubjectCode = "CS3100", SubjectName = "Paradigms of Programming", Professor = "K.C.Sivaramakrishnan", StartDate = new DateTime(2023, 06, 05), Duration = "74", PortionCompletion = 100, ParentId = 38 },
                new Course(){ CourseId = 40, Department = "Semester 5" , Batch = "2021-2025", SubjectCode = "CS3500", SubjectName = "Operating Systems", Professor = "Balaraman Ravindran", StartDate = new DateTime(2023, 06, 12), Duration = "74", PortionCompletion = 100, ParentId = 38 },
                new Course(){ CourseId = 41, Department = "Semester 5" , Batch = "2021-2025", SubjectCode = "CS3300", SubjectName = "Compiler Design", Professor = "Rupesh Nasre", StartDate = new DateTime(2023, 06, 19), Duration = "74", PortionCompletion = 100, ParentId = 38 },

                new Course(){CourseId = 42, Department = "Theoretical Exams", StartDate = new DateTime(2023,11,09), Duration="12", PortionCompletion = 100, ParentId = 38, Predecessor = "38,39,40"},

                new Course(){ CourseId = 43, Department = "Semester 6" , Batch = "2021-2025", SubjectCode = "BT1010", SubjectName = "Life Sciences", Professor= "Himanshu Sinha", StartDate = new DateTime(2024, 01, 08), Duration = "72", PortionCompletion = 90, ParentId = 38 },

                new Course(){CourseId = 44, Department = "Theoretical Exams", StartDate = new DateTime(2024,05,20), Duration="1", PortionCompletion = 0, ParentId = 38, Predecessor = "43"},
        ...
        private List<Course> GetProfessorCollection()
        {
            var courses = new List<Course>()
            {
                ...
                new Course(){ CourseId = 3, Department = "Semester 1", Batch = "2023-2027", SubjectCode = "MA1101", SubjectName = "Functions of Several Variables", Professor = "Arindama Singh", PortionCompletion = 100, StartDate = new DateTime(2023, 06, 05), Duration = "74", ParentId = 2 },
                new Course(){ CourseId = 4, Department = "Semester 2", Batch = "2023-2027", SubjectCode = "MA1102", SubjectName = "Series and Matrices", Professor = "Arindama Singh", StartDate = new DateTime(2024, 01, 08), Duration = "72", PortionCompletion = 90, ParentId = 2 },
                new Course(){ CourseId = 5, Department = "Second Year", Batch = "2022-2026", ParentId = 1 },
                new Course(){ CourseId = 6, Department = "Semester 3", Batch = "2022-2026", SubjectCode = "MA2130", SubjectName = "Basic Graph Theory", Professor = "Arindama Singh", PortionCompletion = 100, StartDate = new DateTime(2023, 06, 05), Duration = "74", ParentId = 5 },
                ...
                new Course(){ CourseId = 9, Department = "Semester 1", Batch = "2023-2027", SubjectCode = "PH1010", SubjectName = "Physics I", Professor = "L.Sriramkumar", PortionCompletion = 100, StartDate = new DateTime(2023, 06, 12), Duration = "74", ParentId = 8 },
                new Course(){ CourseId = 10, Department = "Semester 1", Batch = "2023-2027", SubjectCode = "PH1030", SubjectName = "Physics Lab I", Professor = "L.Sriramkumar", PortionCompletion = 100, StartDate = new DateTime(2023, 06, 12), Duration = "74", ParentId = 8 },
                new Course(){ CourseId = 11, Department = "Semester 2", Batch = "2023-2027", SubjectCode = "PH1020", SubjectName = "Physics II", Professor = "L.Sriramkumar", StartDate = new DateTime(2024, 01, 15), Duration = "75", PortionCompletion = 78, ParentId = 8 },
                ...
                new Course(){ CourseId = 14, Department = "Semester 1", Batch = "2023-2027", SubjectCode = "CY1001", SubjectName = "Chemistry 1", Professor = "Arti Dua", PortionCompletion = 100, StartDate = new DateTime(2023, 06, 26), Duration = "73", ParentId = 13 },
                ...
                new Course(){ CourseId = 17, Department = "Semester 1", Batch = "2023-2027", SubjectCode = "AM1100", SubjectName = "Engineering Mechanics", Professor = "Swathi Sudhakar", PortionCompletion = 100, StartDate = new DateTime(2023, 06, 19), Duration = "74", ParentId = 16 },
                ...
                new Course(){ CourseId = 20, Department = "Semester 1", Batch = "2023-2027", SubjectCode = "CS1111", SubjectName = "Problem Solving using Computers", Professor = "Rupesh Nasre", PortionCompletion = 100, StartDate = new DateTime(2023, 07, 03), Duration = "73", ParentId = 19 },
                new Course(){ CourseId = 21, Department = "Second Year", Batch = "2022-2026", ParentId = 18 },
                new Course(){ CourseId = 22, Department = "Semester 3", Batch = "2022-2026", SubjectCode = "CS2700", SubjectName = "Programming and Data Structures", Professor = "Rupesh Nasre", StartDate = new DateTime(2023, 06, 19), Duration = "74", PortionCompletion = 100, ParentId = 21 },
                new Course(){ CourseId = 23, Department = "Third Year", Batch = "2021-2025", ParentId = 18 },
                new Course(){ CourseId = 24, Department = "Semester 5", Batch = "2021-2025", SubjectCode = "CS3300", SubjectName = "Compiler Design", Professor = "Rupesh Nasre", StartDate = new DateTime(2023, 06, 19), Duration = "74", PortionCompletion = 100, ParentId = 23 },
                ...
                new Course(){ CourseId = 27, Department = "Semester 3", Batch = "2022-2026", SubjectCode = "HS4060", SubjectName = "Humanities Elective 1", Professor = "C.Balaji", PortionCompletion = 100, StartDate = new DateTime(2023, 06, 12), Duration = "74", ParentId = 26 },
                new Course(){ CourseId = 28, Department = "Final Year", Batch = "2020-2024", ParentId = 25 },
                new Course(){ CourseId = 29, Department = "Semester 7", Batch = "2020-2024", SubjectCode = "HS4210", SubjectName = "Literature and values", Professor = "C.Balaji", StartDate = new DateTime(2023, 06, 05), Duration = "74", PortionCompletion = 100, ParentId = 28 },
                ...
                new Course(){ CourseId = 32, Department = "Semester 3", Batch = "2022-2026", SubjectCode = "CS2300", SubjectName = "Foundations of Computer Systems Design", Professor = "C.Chandra Sekhar", StartDate = new DateTime(2023, 07, 03), Duration = "73", PortionCompletion = 100, ParentId = 31 },
                new Course(){ CourseId = 33, Department = "Semester 4", Batch = "2022-2026", SubjectCode = "CS2600", SubjectName = "Computer Organization and Architecture", Professor = "C.Chandra Sekhar", StartDate = new DateTime(2024, 01, 22), Duration = "72", PortionCompletion = 100, ParentId = 31 },
                new Course(){ CourseId = 34, Department = "Final Year", Batch = "2020-2024", ParentId = 30 },
                new Course(){ CourseId = 35, Department = "Semester 7", Batch = "2020-2024", SubjectCode = "CS6025", SubjectName = "Deep Learning", Professor = "C.Chandra Sekhar", StartDate = new DateTime(2023, 06, 12), Duration = "74", PortionCompletion = 100, ParentId = 34 },
                ...
                new Course(){ CourseId = 38, Department = "Semester 5" , Batch = "2021-2025", SubjectCode = "CS3500", SubjectName = "Operating Systems", Professor = "Balaraman Ravindran", StartDate = new DateTime(2023, 06, 12), Duration = "74", PortionCompletion = 100, ParentId = 37 },
                ...
                new Course(){ CourseId = 41, Department = "Semester 2" , Batch = "2023-2027", SubjectCode = "ME1480", SubjectName = "Engineering Drawings", Professor = "Balakrishna Rao", StartDate = new DateTime(2024, 01, 29), Duration = "72", PortionCompletion = 64, ParentId = 40 },
                ...
                new Course(){ CourseId = 44, Department = "Semester 8" , Batch = "2020-2024", SubjectCode = "HS3050", SubjectName = "Professional Ethics", Professor = "Deleep R.Nair", StartDate = new DateTime(2024, 01, 08), Duration = "72", PortionCompletion = 90, ParentId = 43 },
                ...
                new Course(){ CourseId = 47, Department = "Semester 1" , Batch = "2023-2027", SubjectCode = "ID1200", SubjectName = "Ecology and Environment", Professor = "Dr.Abhijit P.Deshpande", PortionCompletion = 100, StartDate = new DateTime(2023, 07, 17), Duration = "73", ParentId = 46 },
                ...
                new Course(){ CourseId = 50, Department = "Semester 6" , Batch = "2021-2025", SubjectCode = "BT1010", SubjectName = "Life Sciences", Professor= "Himanshu Sinha", StartDate = new DateTime(2024, 01, 08), Duration = "72", PortionCompletion = 90, ParentId = 49 },
                ...
                new Course(){ CourseId = 53, Department = "Semester 2" , Batch = "2023-2027", SubjectCode = "EE1100", SubjectName = "Basic Electrical Engineering", Professor = "Jayaraj", StartDate = new DateTime(2024, 02, 12), Duration = "72", PortionCompletion = 46, ParentId = 52 },
                ...
                new Course(){ CourseId = 56, Department = "Semester 4" , Batch = "2022-2026", SubjectCode = "CS2200", SubjectName = "Languages, Machines, and Computations", Professor = "John Augustine", StartDate = new DateTime(2024, 01, 08), Duration = "72", PortionCompletion = 90, ParentId = 55 },
                ...
                new Course(){ CourseId = 59, Department = "Semester 5" , Batch = "2021-2025", SubjectCode = "CS3100", SubjectName = "Paradigms of Programming", Professor = "K.C.Sivaramakrishnan", StartDate = new DateTime(2023, 06, 05), Duration = "74", PortionCompletion = 100, ParentId = 58 },
                ...
                new Course(){ CourseId = 62, Department = "Semester 4" , Batch = "2022-2026", SubjectCode = "CS2810", SubjectName = "Object-Oriented Algorithms Implementation and Analysis Lab", Professor = "Kartik Nagar", StartDate = new DateTime(2024, 02, 05), Duration = "72", PortionCompletion = 57, ParentId = 61 },
                ...
                new Course(){ CourseId = 65, Department = "Semester 3" , Batch = "2022-2026", SubjectCode = "CS2310", SubjectName = "Foundations of Computer Systems Design Lab", Professor = "Madhu Mutyam", StartDate = new DateTime(2023, 07, 03), Duration = "73", PortionCompletion = 100, ParentId = 64 },
                ...
                new Course(){ CourseId = 68, Department = "Semester 3" , Batch = "2022-2026", SubjectCode = "CS2710", SubjectName = "Programming and Data Structures Lab", Professor = "Meghana Nasre", StartDate = new DateTime(2023, 06, 26), Duration = "73", PortionCompletion = 100, ParentId = 67 },
                ...
                new Course(){ CourseId = 71, Department = "Semester 8" , Batch = "2020-2024", SubjectCode = "HS3002", SubjectName = "Principle of Economics", Professor = "Muraleedharan VR", StartDate = new DateTime(2024, 01, 15), Duration = "75", PortionCompletion = 78, ParentId = 70 },
                ...
                new Course(){ CourseId = 74, Department = "Semester 2" , Batch = "2023-2027", SubjectCode = "CS1200", SubjectName = "Discrete Mathematics for CS", Professor = "Nishad Kothari" , StartDate = new DateTime(2024, 01, 22), Duration = "72", PortionCompletion = 74, ParentId = 73 },
                ...
                new Course(){ CourseId = 77, Department = "Semester 4" , Batch = "2022-2026", SubjectCode = "MA2040", SubjectName = "Probability, Stochastic Process and Statistics", Professor = "Sarang Sane",  StartDate = new DateTime(2024, 02, 12), Duration = "72", PortionCompletion = 46, ParentId = 76 },
                ...
                new Course(){ CourseId = 80, Department = "Semester 4" , Batch = "2022-2026", SubjectCode = "CS2800", SubjectName = "Design and Analysis of Algorithms", Professor = "Shweta Agrawal" , StartDate = new DateTime(2024, 01, 15), Duration = "75", PortionCompletion = 78, ParentId = 79 },
                ...
                new Course(){ CourseId = 83, Department = "Semester 2" , Batch = "2023-2027", SubjectCode = "GN1102", SubjectName = "Life Skills II",  Professor = "Sivakumar.M.S", StartDate = new DateTime(2024, 02, 19), Duration = "72", PortionCompletion = 36, ParentId = 82 }
        ...
        private List<Course> GetExamCollection()
        {
            var courses = new List<Course>()
            {
                ...
                new Course(){CourseId = 3, Department = "Semester 1", SubjectName="Partical Exams", StartDate = new DateTime(2023,11,01), Duration="3", PortionCompletion = 100, ParentId = 2 },
                new Course(){CourseId = 4, Department = "Semester 2", SubjectName="Partical  Exams",StartDate = new DateTime(2024,05,08), Duration="3", PortionCompletion = 0, ParentId = 2 },
                new Course(){CourseId = 5, Department = "Second Year", ParentId = 1 },
                new Course(){CourseId = 6, Department = "Semester 3", SubjectName="Partical Exams",StartDate = new DateTime(2023,11,01), Duration="4", PortionCompletion = 100, ParentId = 5 },
                new Course(){CourseId = 7, Department = "Semester 4", SubjectName = "Partical Exams", StartDate = new DateTime(2024,05,08), Duration="4", PortionCompletion = 0, ParentId = 5 },

                new Course(){CourseId = 8, Department = "Theoretical Exams"},
                new Course(){CourseId = 9, Department = "First Year", ParentId = 8 },
                new Course(){CourseId = 10, Department = "Semester 1", SubjectName = "Theoretical Exams", StartDate = new DateTime(2023,11,06), Duration="15", PortionCompletion = 100, ParentId = 9},
                new Course(){CourseId = 11, Department = "Semester 2", SubjectName = "Theoretical Exams", StartDate = new DateTime(2024,05,13), Duration="15", PortionCompletion = 0, ParentId = 9},
                new Course(){CourseId = 12, Department = "Second Year", ParentId = 8 },
                new Course(){CourseId = 13, Department = "Semester 3", SubjectName = "Theoretical Exams", StartDate = new DateTime(2023,11,08), Duration="15", PortionCompletion = 100, ParentId = 12},
                new Course(){CourseId = 14, Department = "Semester 4", SubjectName = "Theoretical Exams", StartDate = new DateTime(2024,05,15), Duration="15", PortionCompletion = 0, ParentId = 12},
                new Course(){CourseId = 15, Department = "Third Year" , ParentId = 8 },
                new Course(){CourseId = 16, Department = "Semester 5", SubjectName = "Theoretical Exams", StartDate = new DateTime(2023,11,09), Duration="12", PortionCompletion = 100, ParentId = 15},
                new Course(){CourseId = 17, Department = "Semester 6", SubjectName = "Theoretical Exams", StartDate = new DateTime(2024,05,20), Duration="1", PortionCompletion = 0, ParentId = 15},
                new Course(){CourseId = 18, Department = "Final Year" , ParentId = 8 },
                new Course(){CourseId = 19, Department = "Semester 7", SubjectName = "Theoretical Exams", StartDate = new DateTime(2023,11,22), Duration="1", PortionCompletion = 100, ParentId = 18},
                new Course(){CourseId = 20, Department = "Semester 8", SubjectName = "Theoretical Exams", StartDate = new DateTime(2024,05,15), Duration="10", PortionCompletion = 0, ParentId = 18},
            };
            return courses;
        }
